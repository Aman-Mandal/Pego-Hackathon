...
const Footer = () => {
  ...
  return (
    <div className="w-full text-white px-20  bg-[#1a1a1a] py-20 font-Poppins">
      <h2 className="text-3xl font-semibold mb-10">PegoCall.</h2>
      <p className="text-gray-400 mb-12">
        PegoCall is currrently built for Pego Network Hackathon and should be
      ...
      <div className="flex justify-between font-light text-white items-center">
        <p className="text-sm">&#169; 2023 PegoCall Inc.</p>
